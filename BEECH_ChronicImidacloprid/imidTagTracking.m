...
parpool(4);
webread('http://lab.debivort.org/mu.php?id=jdrcBench&st=1');
%% 
...
%for bb = 1:numel(dirList) %Loop across colony positions
 for bb =6   %% Data from colony position-level directory
...
webread('http://lab.debivort.org/mu.php?id=jdrcBench&st=2');